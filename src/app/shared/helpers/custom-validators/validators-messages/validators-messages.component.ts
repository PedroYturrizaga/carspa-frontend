    ...
    builtInValidators: {
        ...
        pattern: {
            ...
            realPrices: {
                ...
                validatorPattern: '([0-9]{1,5}(\\.[0-9]{1,2})?)',
                inputPattern: '[0-9\\.]',
                msg: 'Uno o dos decimales'
            },
            ...
            soloUnEspacioLetra: {
                validatorPattern: '(([a-zA-Z]+\\s)*[a-zA-Z])',
...
export class ValidatorsMessagesComponent implements OnInit {
    ...
    private getValidationMessage(_controlVar: any): string {
    ...
    private getQuantifierString(_newRequiredPattern: string, _patternFromValidator: string): string {
        return _newRequiredPattern.slice(_patternFromValidator.length);
    }

    // trae el mensaje del cuantificador
    private getQuantifierMessage(_strQuantifier: string): string {
    ...
    private getQuantifierPattern(_strQuantifier: string): string {
    ...
    private setValidationMessageCondition(_controlVar: any, _ngDirty?: boolean, _ngTouched?: boolean): boolean {
        // leonel
        // puse la condicion de undefined
    ...
    private removeRegexFlags(_requiredPattern: string) {
    ...
    private removeRegexExactString(_requiredPattern: string) {
    ...
    private removeEdges(_str: string) {
    ...
    private replaceCharIfIncluded(_message: string, _newValue: string, _char: string) {
