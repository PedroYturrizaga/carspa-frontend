...
@Component({
  selector: 'app-tarifario-content',
  templateUrl: './tarifario-content.component.html',
  styleUrls: ['./tarifario-content.component.scss']
})
export class TarifarioContentComponent implements OnInit {
  ...
  goToModulo(modulo) {
    ...
    this._router.navigate(['/principal/tarifario/' + modulo]);
  }
